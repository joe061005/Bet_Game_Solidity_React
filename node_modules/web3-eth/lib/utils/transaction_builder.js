...
const getTransactionFromOrToAttr = (attr, web3Context, transaction, privateKey) => {
    if (transaction !== undefined && attr in transaction && transaction[attr] !== undefined) {
        if (typeof transaction[attr] === 'string' && (0, web3_utils_1.isAddress)(transaction[attr])) {
            return transaction[attr];
        }
        if ((0, web3_validator_1.isNumber)(transaction[attr])) {
...
const getTransactionNonce = (web3Context, address, returnFormat = web3_utils_1.DEFAULT_RETURN_FORMAT) => __awaiter(void 0, void 0, void 0, function* () {
...
const getTransactionType = (transaction, web3Context) => {
    ...
    if (!(0, web3_validator_1.isNullish)(web3Context.defaultTransactionType))
        return (0, web3_utils_1.format)({ eth: 'uint' }, web3Context.defaultTransactionType, web3_utils_1.ETH_DATA_FORMAT);
    return undefined;
};
...
function defaultTransactionBuilder(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        let populatedTransaction = (0, web3_utils_1.format)(schemas_1.transactionSchema, options.transaction, web3_utils_1.DEFAULT_RETURN_FORMAT);
        ...
        if ((0, web3_validator_1.isNullish)(populatedTransaction.nonce)) {
            populatedTransaction.nonce = yield (0, exports.getTransactionNonce)(options.web3Context, populatedTransaction.from, web3_utils_1.ETH_DATA_FORMAT);
        }
        ...
        if ((0, web3_validator_1.isNullish)(populatedTransaction.data) || populatedTransaction.data === '') {
        ...
        if ((0, web3_validator_1.isNullish)(populatedTransaction.chainId) &&
            ...
            populatedTransaction.chainId = yield (0, rpc_method_wrappers_1.getChainId)(options.web3Context, web3_utils_1.ETH_DATA_FORMAT);
        }
        if ((0, web3_validator_1.isNullish)(populatedTransaction.networkId)) {
            populatedTransaction.networkId =
                (_b = options.web3Context.defaultNetworkId) !== null && _b !== void 0 ? _b : (yield (0, web3_net_1.getId)(options.web3Context, web3_utils_1.ETH_DATA_FORMAT));
        }
        ...
        populatedTransaction = Object.assign(Object.assign({}, populatedTransaction), (yield (0, get_transaction_gas_pricing_1.getTransactionGasPricing)(populatedTransaction, options.web3Context, web3_utils_1.ETH_DATA_FORMAT)));
