...
export declare function getTransactionError<ReturnFormat extends DataFormat>(web3Context: Web3Context, transactionFormatted?: TransactionCall, transactionReceiptFormatted?: FormatType<TransactionReceipt, ReturnFormat>, receivedError?: unknown, contractAbi?: ContractAbi, knownReason?: string | RevertReason | RevertReasonWithCustomError): Promise<TransactionRevertedWithoutReasonError<{
    readonly transactionHash: import("web3-utils").ByteTypes[ReturnFormat["bytes"]];
    readonly transactionIndex: import("web3-utils").NumberTypes[ReturnFormat["number"]];
    readonly blockHash: import("web3-utils").ByteTypes[ReturnFormat["bytes"]];
    readonly blockNumber: import("web3-utils").NumberTypes[ReturnFormat["number"]];
    readonly from: string;
    readonly to: string;
    readonly cumulativeGasUsed: import("web3-utils").NumberTypes[ReturnFormat["number"]];
    readonly gasUsed: import("web3-utils").NumberTypes[ReturnFormat["number"]];
    readonly effectiveGasPrice?: import("web3-utils").NumberTypes[ReturnFormat["number"]] | undefined;
    ...
    readonly logsBloom: import("web3-utils").ByteTypes[ReturnFormat["bytes"]];
    readonly root: import("web3-utils").ByteTypes[ReturnFormat["bytes"]];
    readonly status: import("web3-utils").NumberTypes[ReturnFormat["number"]];
    readonly type?: import("web3-utils").NumberTypes[ReturnFormat["number"]] | undefined;
